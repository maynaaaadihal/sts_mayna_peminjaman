...
<div class="container">
    <div class="row mt-5">
        <div class="col-md-6">
        <h2>Detail Barang :</h2>
         <img src="Pakaian_adat_tari_jaipong.jpeg" alt="" weight="450" height="450">
         <div class="col-md-12">
            <h3>Berikut ini Detail Barang yaitu:</h3>
            <h4>nama Baju : Tari Jaipong</h4>
            <h4>ukuran Baju : M , L</h4>
            <h4>warna Baju  : Hitam Emas corak</h4>
            <h4>jumlah Baju : 2</h4>
         </div>
        </div>
    </div>
